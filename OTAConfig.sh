...
do
    case $opt in
        "Xperia U")
			...
			echo "========================================"
			echo "Enter build ID like SlimKatXperia for SlimKatXperia Team (don't use special characters, - _ , spaces, etc... )"
			read buildid
			echo "========================================"
			echo "Enter name of the build (otaupdater.otaver) like Build2 or Pre2Build7 (don't use special characters, - _ , spaces, etc... )"
			read buildname
			echo "========================================"
			echo "Enter date of $buildname like 20140623-1337 (YearMonthDay-HourMinutes)"
			read builddate
